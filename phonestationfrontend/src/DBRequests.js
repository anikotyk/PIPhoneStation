...
export let getUserAddedServices = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/get-all-client-added-services", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId,
            }),
...
export let getUserPaidServices = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/get-all-client-paid-services", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId,
            }),
...
export let confirmClient = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/confirm-client", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId
            }),
...
export let banClient = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/ban-client", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId
            }),
...
export let unbanClient = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/unban-client", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId
            }),
...
export let getUserUnpaidServices = async (clientId, e) => {
    try {
        let res = await fetch("http://localhost:8080/phonestation/get-all-client-unpaid-services", {
            method: "POST",
            body: JSON.stringify({
                clientId: clientId,
            }),
